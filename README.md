...
評価CSVには第三者データ由来の質問・参照回答を含みます。出典とMITライセンスは上記の通りです。ベースモデルを利用する際は、[Gemma 3 1B IT](https://huggingface.co/google/gemma-3-1b-it)の利用条件に従ってください。このrepository自体のライセンスは未設定です。
